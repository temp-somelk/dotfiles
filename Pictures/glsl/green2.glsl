...
const int complexity = 13;
const float fluid_speed = 3000.0;
const float red = 0.14;
const float green = 0.19;
const float blue = 0.08;
...
void main()
{
  ...
  for(int i=1;i<complexity;i++)
  {
    ...
    vec3 col = vec3(0.3/vv*3.1,0.05/vv2*1.95,vv2*.4);
    if (col.g > 0.0)
    {
        col.b = 0.0;
        col.r = 0.0;
